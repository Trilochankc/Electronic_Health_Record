        ...
        <div class="content">
            ...
            <div class="block block-rounded invisible" data-toggle="appear">
                <div class="block-header block-header-default">
                    <h3 class="block-title">Make New Appointment</h3>
                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="address" name="address" value="{{$users->address}}" placeholder="Your Address">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control"  id="appointments_for" name="appointments_for"  placeholder="Subject">{{old('appointments_for')}}</textarea>
